...
from autonomon import ActionPlan, AvoidancePlanner, WorldStateUpdate


def _state(obstacle_ahead: bool = False, cliff_detected: bool = False) -> WorldStateUpdate:
...
async def _run_states(
    planner: AvoidancePlanner, states: list[WorldStateUpdate]
) -> list[ActionPlan]:
